...
var SAGE2Connection = {
	...
	connectToPele: function(divToUseForStatusOutput) {
		if (divToUseForStatusOutput) {
			this.statusOutputDiv = divToUseForStatusOutput;
			this.statusOutputDiv.innerHTML += "Attempting connection to SAGE2 server\n<br>";
		}
		console.log("Attempting connection to SAGE2 server");

		// make a note after connecting
		SAGE2Connection.afterSAGE2Connection = SAGE2Connection.openNoteAfterConnection;

		// initS2Connection: function(s2Hostname = null, session = null, isMasterDisplayOrUniqueWebpage = true, appIdOfWebview = null) {
		SAGE2Connection.initS2Connection("pele.manoa.hawaii.edu", "cf5bf2ab230c9740415984b28b23661e", true);
	},
	connectToLocalhost: function(divToUseForStatusOutput, port="9292") {
		if (divToUseForStatusOutput) {
			this.statusOutputDiv = divToUseForStatusOutput;
			this.statusOutputDiv.innerHTML += "Attempting connection to SAGE2 server\n<br>";
		}
		...
		// initS2Connection: function(s2Hostname = null, session = null, isMasterDisplayOrUniqueWebpage = true, appIdOfWebview = null) {
		SAGE2Connection.initS2Connection("localhost:" + port, "cf5bf2ab230c9740415984b28b23661e", true);
	},
	openNoteAfterConnection: function() {
		if (this.statusOutputDiv) {
			this.statusOutputDiv.innerHTML += "Attempting to create note\n<br>";
		}
		console.log("Attempting to create note");
		// var data = {};
		// data.appName	= "quickNote";
		// data.customLaunchParams		= {};
		// data.customLaunchParams.clientName = "WebpageClient>" + this.uniqueID;
		// data.customLaunchParams.clientInput = "This note was automatically generated by an external webpage registered as SAGE2 client "
		// 	+ this.uniqueID + " using websocket connection. If you see this note, the webpage established an open communication channel."
		// 	+ "<br>--Additional information--"
		// 	+ "<br>hostname: " + this.hostname
		// 	+ "<br>uniqueId: " + this.uniqueID
		// 	+ "<br>isMaster: " + this.isMaster
		// 	+ "<br>isMaster/uniqueWebpage: " + this.isMaster
		// 	+ "<br>webview: " + this.appId;
		// data.customLaunchParams.colorChoice = "lightyellow";
		// this.wsio.emit('launchAppWithValues', data);
		// if (this.statusOutputDiv) {
		// 	this.statusOutputDiv.innerHTML += "Launch app packet sent\n<br>";
		// }
		// console.log("Launch app packet sent");


		// need to use old version, above is for the repo currently working on.
		var data = {};
		data.type		= "launchAppWithValues";
		data.appName	= "quickNote";
		// data.func		= "setMessage";
		data.csdInitValues		= {};
		data.csdInitValues.clientName = "WebpageClient>" + this.uniqueID;
		data.csdInitValues.clientInput =  "This note was automatically generated by an external webpage registered as SAGE2 client "
				+ this.uniqueID + " using websocket connection. If you see this note, the webpage established an open communication channel."
				+ "<br>--Additional information--"
				+ "<br>hostname: " + this.hostname
				+ "<br>uniqueId: " + this.uniqueID
		...
		this.wsio.emit('csdMessage', data);
	},
	...
	*/
	...
	setupListeners: function() {
		...
		this.wsio.on("initialize", function(data) {
			...
			if (_this.statusOutputDiv) {
				_this.statusOutputDiv.innerHTML += "Webpage connected to server and received uniqueID:" + data.UID + "\n<br>";
			}
			console.log("Webpage connected to server and received uniqueID:" + data.UID);
